...
constructor(props){
  super(props);
  this.state = {projects:[
    {name:"Multi school Management",description:"A Website (SAAS) that lets schools create a working online school management software and also a website",image:"http://localhost/pryper/assets/images/projects/getd.png",link:"https://niyiojeyinka.heroku.com",github:"https://github.com/Niyiojeyinka/My-Portfolio.git",stacks:["PHP","MYSQL"]},
