...
constructor(props){
  super(props);
  this.state = {projects:[
    {name:"CBT",description:"A Computer Based Testing Software ideally for schools and colleges(password:user,email:user@gmail.com)",image:"http://localhost/pryper/assets/images/projects/cbt.png",link:"https://niyiojeyinka.heroku.com",github:"https://github.com/Niyiojeyinka/PHPonlineCBT-",stacks:["PHP","MYSQL"]},
    {name:"Multi school Management",description:"A Website (SAAS) that lets schools create a  school management web software and also a website(password:user,phone:12345678)",image:"http://localhost/pryper/assets/images/projects/getd.png",link:"https://niyiojeyinka.heroku.com",github:"https://github.com/Niyiojeyinka/My-Portfolio.git",stacks:["PHP","MYSQL"]},
    {name:"Web Creator",description:"An Online theme based web creator and designer that let users create their own website in few clicks(password:user,email:user@gmail.com)",image:"http://localhost/pryper/assets/images/projects/web2.png",link:"https://niyiojeyinka.heroku.com",github:"https://github.com/Niyiojeyinka/My-Portfolio.git",stacks:["PHP","MYSQL"]},
    {name:"Pryper Q Bet",description:"A Question Betting Web Apllication that let people bet on Questions from topics they care about (password:user,email:user@gmail.com)",image:"http://localhost/pryper/assets/images/projects/py.png",link:"https://niyiojeyinka.heroku.com",github:"https://github.com/Niyiojeyinka/My-Portfolio.git",stacks:["PHP","MYSQL"]},
    {name:"AdNetwork",description:"Advertising Network Server  (password:user,email:user@gmail.com)",image:"http://localhost/pryper/assets/images/projects/advertiseradtype.png",link:"",github:"https://www.github.com/niyiojeyinka",stacks:["PHP","MYSQL"]},
    ...
    {name:"E-voting",description:"An online voting web application software Backend (password:admin,username:admin) login link:{domain}/index.php/officer .",image:"http://localhost/pryper/assets/images/projects/vote.png",link:"https://niyiojeyinka.heroku.com",github:"https://github.com/Niyiojeyinka/My-Portfolio.git",stacks:["PHP","MYSQL"]},
    ...
    {name:"CSV Tools",description:"A developer PHP class to generate a CSV file.",image:"http://localhost/pryper/assets/images/projects/csv.png",link:"https://niyiojeyinka.heroku.com",github:"https://github.com/Niyiojeyinka/My-Portfolio.git",stacks:["PHP","MYSQL"]},
    {name:"Business Listing",description:"A Classic Business directory website(password:admin,email:admin@gmail.com)",image:"http://localhost/pryper/assets/images/projects/listing.png",link:"https://niyiojeyinka.heroku.com",github:"https://github.com/Niyiojeyinka/PHPonlineCBT-",stacks:["PHP","MYSQL"]},
