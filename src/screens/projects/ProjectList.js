...
constructor(props){
  super(props);
  this.state = {projects:[
    {name:"AdNetwork",description:"Advertising Network Server  (password:user,email:user@gmail.com)",image:"https://i.ibb.co/nRL91yj/advertiseradtype.png",link:"https://web-web20.000webhostapp.com/ads",github:"https://github.com/Niyiojeyinka/PHP-AdsNetworkServer-",stacks:["PHP","MYSQL"]},
    {name:"Web Creator",description:"An Online theme based web creator and designer that let users create their own website in few clicks(password:user,email:user@gmail.com)",image:"https://i.ibb.co/zbBxKzV/web2.png",link:"https://web-web20.000webhostapp.com/web",github:"https://github.com/Niyiojeyinka/Simple-Theme-Based-Web-builder",stacks:["PHP","MYSQL"]},
    {name:"CBT",description:"A Computer Based Testing Software ideally for schools and colleges(password:user,email:user@gmail.com)",image:"https://i.ibb.co/Wv0Qz3r/cbt.png",link:"https://web-web20.000webhostapp.com/cbt",github:"https://github.com/Niyiojeyinka/PHPonlineCBT-",stacks:["PHP","MYSQL"]},
    {name:"Multi school Management",description:"A Website (SAAS) that lets schools create a  school management web software and also a website(password:user,phone:12345678)",image:"https://i.ibb.co/zNdXKwq/getd.png",link:"https://web-web20.000webhostapp.com/csm",github:"https://github.com/Niyiojeyinka/PHP-Multi-Cloud-School-Management-",stacks:["PHP","MYSQL"]},
    {name:"Pryper Q Bet",description:"A Question Betting Web Apllication that let people bet on Questions from topics they care about (password:user,email:user@gmail.com)",image:"https://i.ibb.co/fHbhZCc/py.png",link:"https://web-web20.000webhostapp.com/bet",github:"https://github.com/Niyiojeyinka/My-Portfolio.git",stacks:["PHP","MYSQL"]},
    {name:"E-voting",description:"An online voting web application software Backend (password:admin,username:admin) login link:{domain}/index.php/officer .",image:"https://i.ibb.co/mB9Pp9B/vote.png",link:"https://web-web20.000webhostapp.com/vote",github:"https://github.com/Niyiojeyinka/My-Portfolio.git",stacks:["PHP","MYSQL"]},
    ...
    {name:"Page Chat",description:"A One page Chat  web application written in PHP ,JAVSCRIPT and MYSQL",image:"https://i.ibb.co/Xjm81j2/opc.png",link:"https://niyiojeyinka.heroku.com",github:"https://github.com/Niyiojeyinka/My-Portfolio.git",stacks:["PHP","MYSQL"]},
