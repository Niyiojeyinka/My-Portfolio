...
constructor(props){
  ...
  this.state = {projects:[
    ...
    {name:"CBT",description:"A Computer Based Testing Software ideally for schools and colleges(password:user,email:user@gmail.com)",image:"https://i.ibb.co/Wv0Qz3r/cbt.png",link:"https://niyiojeyinka.heroku.com",github:"https://github.com/Niyiojeyinka/PHPonlineCBT-",stacks:["PHP","MYSQL"]},
    {name:"Multi school Management",description:"A Website (SAAS) that lets schools create a  school management web software and also a website(password:user,phone:12345678)",image:"https://i.ibb.co/zNdXKwq/getd.png",link:"https://niyiojeyinka.heroku.com",github:"https://github.com/Niyiojeyinka/PHP-Multi-Cloud-School-Management-",stacks:["PHP","MYSQL"]},
